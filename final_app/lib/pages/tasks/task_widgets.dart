...
import 'package:final_app/pages/tasks/row_task.dart';
...
class TasksPage extends StatelessWidget {
  ...
  Widget _buildTaskList(List<Tasks> list) {
    return Padding(
      ...
      child: list.length == 0
          ? MessageInCenterWidget("هیچ فعالیتی اضافه نشده است")
          : Container(
                    ...
                    return Dismissible(
                        ...
                        onDismissed: (DismissDirection direction) {
                          ...
                          if (direction == DismissDirection.endToStart) {
                            ...
                            message = "فعالیت انجام شده";//فعالیت انجام شده
                          } else {
                            _tasksBloc.delete(taskID);
                            message = "فعالیت حذف شده";
                          }
