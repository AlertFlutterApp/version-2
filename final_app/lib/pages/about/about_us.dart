...
import 'package:final_app/utils/app_constant.dart';
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text("دیگر راه های ارتباطی",//Author
                          style: TextStyle(
                              color: Colors.black,
                    ...
                    ListTile(
                      ...
                      subtitle: Text(
                        "Alert Flutter Group Helli3 school",
                    ...
                    ListTile(
                        leading: Icon(Icons.bug_report, color: Colors.black),
                        title: Text("صفحه ی گیت هاب"),
                        onTap: () => launchURL(PROJECT_URL)),
                    ListTile(
                        leading: Icon(Icons.email, color: Colors.black),
                        title: Text("فرستادن پست الکترونیک"),//
                        subtitle: Text(
                          "AlertFlutterApp@gmail.com",
             ...
             /* Card(
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      padding: const EdgeInsets.only(top: 16.0, left: 16.0),
                      child: Text("پرسیدن سوال؟",//Ask Question ?
                          style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.bold,
                              fontSize: FONT_MEDIUM)),
